...
import cc.catface.util.ImageUtil;
...
public class CatfaceController {
    ...
    /// global ///////////////////////////////////////////////
    static final String SAVE_PATH = "d:/ssm/save/";         //
    static final String DOWNLOAD_PATH = "d:/ssm/download/"; //
    //////////////////////////////////////////////////////////

    static {
        File fileSave = new File(SAVE_PATH);
        File fileDownload = new File(DOWNLOAD_PATH);
    ...
    public void uploadByStream(@RequestParam("file") CommonsMultipartFile file) throws IOException {
        OutputStream os = new FileOutputStream(SAVE_PATH + file.getOriginalFilename());
    ...
    public void uploadBySpring(HttpServletRequest request) throws IOException {
        ...
        if (multipartResolver.isMultipart(request)) {
            ...
            while (iterator.hasNext()) {
                ...
                if (null != file) {
                    String desPath = SAVE_PATH + file.getOriginalFilename();
    ...
    public void upload(HttpServletRequest request) throws IOException {
        ...
        if (multiResolver.isMultipart(request)) {
            ...
            for (String key : multiFileMap.keySet()) {
                ...
                multiFileMap.get(key).get(0).transferTo(new File(SAVE_PATH + multiFileMap.get(key).get(0).getOriginalFilename()));
            }
