...
###- 83. 求0—7所能组成的奇数个数
def ex83():
    l = [n1 * 1000000 + n2 * 100000 + n3 * 10000 + n4 * 1000 + n5 * 100 + n6 * 10 + n7 for n1 in range(10) for n2 in range(10) for n3 in range(10) for n4 in range(10) for n5 in range(10) for n6 in range(10) for n7 in range(10) if (n1 * 1000000 + n2 * 100000 + n3 * 10000 + n4 * 1000 + n5 * 100 + n6 * 10 + n7) % 2 != 0]
    return len(l)
...
def ex97():
    file_path = '../../newDir/cainiao_100.txt'
...
def ex98():
    with open('../../newDir/test.txt', 'a', encoding='utf-8') as f:
...
def ex99():
    s1 = s2 = ''
    with open('../../newDir/testB.txt', 'r', encoding='utf-8') as f:
        s1 = f.read()
